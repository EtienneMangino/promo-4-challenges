...
function run_challenges() {
  ...
  $('#email').attr('value', "etienne@hotmail.com");
  ...
  var team_count = $('.table tbody tr').size()  ;  // TODO: replace 0, keep the team_count variable.



  // Ex 6. Say there is a 15th team added to the table.
  //       Add a row at the bottom, this new team should have zero points.
  $('table > tbody').append('<tr> <td>15</td><td>Etienne</td><td>0</td> </tr>');
  ...
  $('.table th').css("background-color","#DDF4FF");


  // Ex 9. Translate the #results list 20px downward (animation would be great ^_^)
  $('#results').css({"-webkit-transform":"translate(0px,20px)"});
